...
var magicLine = (function() {
  ...
  class magicLine {
    constructor(node, settings) {
      ...
      const getNavElements = parent =>
        parent.querySelectorAll(this.settings.navElements);
      /**
      ...
      const onLoad = () => {
        Array.prototype.forEach.call(this.elements, el => {
          el.classList.add(
            "init-magic-line",
            "magic-line-mode-" + this.settings.mode.toLowerCase()
          ...
          let initActive = getActiveElement(getNavElements(el)); // Draw
